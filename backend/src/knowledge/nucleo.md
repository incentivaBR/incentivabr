...
Lei nº 12.213/2010
6% do IR Devido
DIRPF: Doações Efetuadas → Código 44
Base Legal
...
que o proponente do projeto emite em seu nome depois que a transferência é conferida.
- 4
...
Os dados bancários aparecem na etapa de pagamento, vindos do cadastro do projeto. Nunca transfira para uma conta obtida fora desse fluxo.
...
Código: 41 — Incentivo à Cultura (Lei Rouanet)
...
Transfira o valor para a Conta de Captação do projeto, usando PIX, TED ou transferência. É uma conta bloqueada e específica daquele PRONAC — confira os dados na tela antes de transferir.
Os dados bancários aparecem na etapa de pagamento, vindos do cadastro do projeto. Nunca transfira para uma conta obtida fora desse fluxo.
...
Pronto! Você recebe um número de protocolo e um comprovante pessoal. O Recibo de Mecenato oficial é emitido pelo proponente no prazo que ele declara: até 10 dias úteis após a confirmação.
PASSO 6 — FINAL
...
- O proponente declara o prazo de emissão: até 10 dias úteis após a confirmação da transferência
